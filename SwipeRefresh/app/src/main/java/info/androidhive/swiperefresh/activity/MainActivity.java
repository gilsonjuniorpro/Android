...
public class MainActivity extends ActionBarActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private String URL_TOP_250 = "http://www.projectconnect.com.br/youoffer/controller/controllerJson.php?action=listarUsuarioJson";
                        ...
                        if (response.length() > 0) {
                            ...
                            for (int i = 0; i < response.length(); i++) {
                                try {
                                    ...
                                    int rank = movieObj.getInt("codusuario");
                                    String title = movieObj.getString("loginusuario");
